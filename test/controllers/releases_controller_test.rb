...
class ReleasesControllerTest < ActionController::TestCase
  ...
  test "should create release" do
    assert_difference('Release.count') do
      post :create, release: { abstract: @release.abstract, pdf: @release.pdf, pdf_file_name: @release.pdf_file_name, title: @release.title }
    end
  ...
  test "should update release" do
    patch :update, id: @release, release: { abstract: @release.abstract, pdf: @release.pdf, pdf_file_name: @release.pdf_file_name, title: @release.title }
    assert_redirected_to release_path(assigns(:release))
  end
